        ...
        <div class="d-flex align-items-center justify-content-center" style="width: auto;height: 700px;">
            <form action="process.php" method="POST" class="shadow p-3 mb-5 bg-white rounded" style="width: 350px;">
                ...
                <div class="form-label-group">
                    ...
                    <br>
                    <input type="password" name="new_password" class="form-control" placeholder="new password" required="" autofocus="" style="width: 300px;">
                </div>
                <br>
                <div class="col text-center">
                    <button class="btn  btn-primary btn-block" type="submit"  value="Send Email">Reset</button>
                </div>
            </form>
        </div>
