...
<nav class="navbar">
  <ul class="navbar-nav">
    ...
    <li class="nav-item">
      <a href="../Admin_pages/Admin_index.php" class="nav-link">
      <i class="fas fa-users fa-secondary"></i>
        <span class="link-text">User List</span>
      </a>
    </li>

    <li class="nav-item">
      <a href="../Admin_pages/Admin_AddDoc.php" class="nav-link">
      <i class="fas fa-user-md fa-secondary"></i>
        <span class="link-text">Add doctor</span>
      </a>
    </li>

    <li class="nav-item">
      <a href="../Admin_pages/Admin_AddNurse.php" class="nav-link">
      <i class="fas fa-user-nurse fa-secondary"></i>
        <span class="link-text">Add nurse</span>
      </a>
    </li>

    <li class="nav-item">
      <a href="../Admin_pages/Admin_AddInvS.php" class="nav-link">
      <i class="fas fa-inventory fa-secondary"></i>
        <span class="link-text">Add Inventory supervisor</span>
      </a>
    </li>

    <li class="nav-item">
            <a href="../Admin_pages/AdminProfile.php" class="nav-link">
