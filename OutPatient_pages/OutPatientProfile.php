...
Date last edited: 20 February, ‎2021
-->
<!DOCTYPE html>
<?php
            ...
            while ($row = $result->fetch_assoc()) {
                echo '
                        ...
                        <div class="shadow p-3 mb-5 bg-white rounded" style="width: 450px;">
                            ...
                            <button type="button" onclick="getValue()" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">Edit Details</button>
                            </div>         
                        </div>
                    </div>
                ';
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="../process.php" method="POST">
                            <input type="hidden" name="edit_OutPatientprofile" value="">
